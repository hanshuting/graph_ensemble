...
#ifndef _BINARYCLASSIFICATIONLOSS_HPP_
#define _BINARYCLASSIFICATIONLOSS_HPP_
 ...
 */
class CBinaryClassificationLoss : public CScalarLoss 
{
 protected:
...
public:          
        CBinaryClassificationLoss(CModel* &model, CVecData* &data)
                : CScalarLoss(model, data) {}
        
        virtual ~CBinaryClassificationLoss() {}
