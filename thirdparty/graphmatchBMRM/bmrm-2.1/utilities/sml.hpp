...
#ifndef REAL_NUMBER
#define REAL_NUMBER
//#define REAL_NUMBER_IS_FLOAT
//#define Scalar float
#define REAL_NUMBER_IS_DOUBLE
#define Scalar double
#endif

namespace SML {

  const Scalar ZERO_EPS = 1e-20;  
  const Scalar INFTY = 1e30;    // single precision: ~\pm 10^{38.53}; double precision: ~\pm 10^{308.25}
...
public:
  ...
  Scalar Density() const;                     // ratio of nnz/length: max=1, min=0
  Scalar* Data() const;                       // get the mem location of the elements of the object
  
  void Get(const unsigned int& index, Scalar& value) const;                     // get vector element
  void Get(const unsigned int& row, const unsigned int& column, Scalar& value) const;    // get matrix element
  
  void Set(const unsigned int& index, const Scalar& value);                     // set vector element
  void Set(const unsigned int& row, const unsigned int& column, const Scalar& value);    // set matrix element
  ...
  void Dot(const TheMatrix& other, Scalar& output) const;         // dot product of two vectors!
  
  void TransposeDot(const TheMatrix& other, TheMatrix& output) const;    // dot product of vec^T/mat or mat/mat
  void TransposeDot(const TheMatrix& other, Scalar& output) const;         // dot product of two vectors!
  
  void Norm1(Scalar& value) const;    // L_1 norm for vector and matrix
  void Norm2(Scalar& value) const;    // L_2 norm for vector and Frobenius (or Hilbert-Schmidt) norm for matrix
  void NormInf(Scalar& value) const;  // L_\infty norm for vector and matrix
  void IndexNormInf(unsigned int& index) const; // index of entries with largest absolute value
  
  void AddRow(const unsigned int& rowidx, const unsigned int& length, const Scalar* values);                       // Fill a dense row into the matrix (during matrix initialization)
  void AddRow(const unsigned int& rowidx, const unsigned int& length, const Scalar* values, const unsigned int* indices);   // Fill a sparse row into the matrix (during matrix initialization)	 
  void SetRow(const unsigned int& rowidx, const unsigned int& length, const Scalar* values);                       // Set a denserow to the matrix (anytime)
  void SetRow(const unsigned int& rowidx, const unsigned int& length, const Scalar* values, const unsigned int* indices);   // Set a sparse row to the matrix (anytime)
  void GetRow(const unsigned int& rowidx, unsigned int& length, Scalar* values) const;                             // Get a dense row from the matrix
  void GetRow(const unsigned int& rowidx, unsigned int& length, Scalar* values, unsigned int*indices) const;                // Get a sparse row from the matrix
  
  void Scale(const Scalar& scalar);                             // scale the vector/matrix
  void ScaleAdd(const Scalar& scalar, const TheMatrix& other);  // scale other and add to *this
...
private:
  ...
  ublas::vector<Scalar>            *dv;     // dense vector
  ublas::compressed_vector<Scalar> *sv;     // sparse vector
  ublas::matrix<Scalar>            *dm;     // dense matrix
  ublas::compressed_matrix<Scalar> *sm;     // sparse matrix
  ublas::matrix_row<ublas::matrix<Scalar> > *dmr;  // dense matrix row (a vector>
  ublas::matrix_row<ublas::compressed_matrix<Scalar> > *smr;  // sparse matrix row (a vector>
  
  // member function pointers
  void (TheMatrix::*fptr_Dot_1)(const TheMatrix& other, Scalar& output) const;
  void (TheMatrix::*fptr_Dot_2)(const TheMatrix& other, TheMatrix& output) const;
  
  void (TheMatrix::*fptr_TransposeDot_1)(const TheMatrix& other, Scalar& output) const;
  void (TheMatrix::*fptr_TransposeDot_2)(const TheMatrix& other, TheMatrix& output) const;
  
  void (TheMatrix::*fptr_Get_1)(const unsigned int& index, Scalar& value) const;
  void (TheMatrix::*fptr_Get_2)(const unsigned int& row, const unsigned int& column, Scalar& value) const;
  
  void (TheMatrix::*fptr_Set_1)(const unsigned int& index, const Scalar& value);
  void (TheMatrix::*fptr_Set_2)(const unsigned int& row, const unsigned int& column, const Scalar& value);
  
  void (TheMatrix::*fptr_AddRow_1)(const unsigned int& rowidx, const unsigned int& length, const Scalar* values);
  void (TheMatrix::*fptr_AddRow_2)(const unsigned int& rowidx, const unsigned int& length, const Scalar* values, const unsigned int* indices);
  
  void (TheMatrix::*fptr_SetRow_1)(const unsigned int& rowidx, const unsigned int& length, const Scalar* values);
  void (TheMatrix::*fptr_SetRow_2)(const unsigned int& rowidx, const unsigned int& length, const Scalar* values, const unsigned int* indices);
  
  void (TheMatrix::*fptr_GetRow_1)(const unsigned int& rowidx, unsigned int& length, Scalar* values) const;
  void (TheMatrix::*fptr_GetRow_2)(const unsigned int& rowidx, unsigned int& length, Scalar* values, unsigned int* indices) const;
  
  void (TheMatrix::*fptr_ScaleAdd_1)(const Scalar& scalar, const TheMatrix& other);
  ...
  // dot product
  void dv_dot_v(const TheMatrix& other, Scalar& output) const;      // dv dot vector
  void dv_dot_m(const TheMatrix& other, TheMatrix& output) const;   // dv dot matrix
  void sv_dot_v(const TheMatrix& other, Scalar& output) const;      // sv dot vector
  ...
  void dmr_dot_v(const TheMatrix& other, Scalar& output) const;      // dmr dot vector
  void dmr_dot_m(const TheMatrix& other, TheMatrix& output) const;      // dmr dot matrix
  void smr_dot_v(const TheMatrix& other, Scalar& output) const;      // smr dot vector
  ...
  // get a value
  void dv_get(const unsigned int& index, Scalar& value) const;
  void dv_get2(const unsigned int& row, const unsigned int& column, Scalar& value) const;
  void sv_get(const unsigned int& index, Scalar& value) const;
  void sv_get2(const unsigned int& row, const unsigned int& column, Scalar& value) const;
  void dm_get(const unsigned int& row, const unsigned int& column, Scalar& value) const;
  void sm_get(const unsigned int& row, const unsigned int& column, Scalar& value) const;
  void dmr_get(const unsigned int& index, Scalar& value) const;
  void smr_get(const unsigned int& index, Scalar& value) const;
  
  // set a value
  void dv_set(const unsigned int& index, const Scalar& value);
  void dv_set2(const unsigned int& row, const unsigned int& column, const Scalar& value);
  void sv_set(const unsigned int& index, const Scalar& value);
  void sv_set2(const unsigned int& row, const unsigned int& column, const Scalar& value);
  void dm_set(const unsigned int& row, const unsigned int& column, const Scalar& value);
  void sm_set(const unsigned int& row, const unsigned int& column, const Scalar& value);
  void dmr_set(const unsigned int& index, const Scalar& value);
  void smr_set(const unsigned int& index, const Scalar& value);
  
  // add a row
  void dm_addrow_dense(const unsigned int& rowidx, const unsigned int& length, const Scalar* values);
  void dm_addrow_sparse(const unsigned int& rowidx, const unsigned int& length, const Scalar* values, const unsigned int* indices);
  void sm_addrow_dense(const unsigned int& rowidx, const unsigned int& length, const Scalar* values);
  void sm_addrow_sparse(const unsigned int& rowidx, const unsigned int& length, const Scalar* values, const unsigned int* indices);
  // dense and sparse vector: addrow == setrow  
  void v_addrow_dense(const unsigned int& rowidx, const unsigned int& length, const Scalar* values);
  void v_addrow_sparse(const unsigned int& rowidx, const unsigned int& length, const Scalar* values, const unsigned int* indices);
  ...
  void sm_setrow_dense(const unsigned int& rowidx, const unsigned int& length, const Scalar* values);
  void sm_setrow_sparse(const unsigned int& rowidx, const unsigned int& length, const Scalar* values, const unsigned int* indices);  
  
  // get a row
  void dm_getrow_dense(const unsigned int& rowidx, unsigned int& length, Scalar* values) const;
  void dm_getrow_sparse(const unsigned int& rowidx, unsigned int& length, Scalar* values, unsigned int* indices) const;
  void sm_getrow_dense(const unsigned int& rowidx, unsigned int& length, Scalar* values) const;
  void sm_getrow_sparse(const unsigned int& rowidx, unsigned int& length, Scalar* values, unsigned int* indices) const; 
  void v_getrow_dense(const unsigned int& rowidx, unsigned int& length, Scalar* values) const;
  void v_getrow_sparse(const unsigned int& rowidx, unsigned int& length, Scalar* values, unsigned int* indices) const;
  
  // scale other and add to *this
  void dv_scaleadd(const Scalar& scalar, const TheMatrix& other);   
  void sv_scaleadd(const Scalar& scalar, const TheMatrix& other);
  void dm_scaleadd(const Scalar& scalar, const TheMatrix& other); 
  void sm_scaleadd(const Scalar& scalar, const TheMatrix& other);
  void dmr_scaleadd(const Scalar& scalar, const TheMatrix& other); 
  void smr_scaleadd(const Scalar& scalar, const TheMatrix& other);
 ...
 */
inline Scalar TheMatrix::Density() const
{
        using namespace SML;      
 ...
 * Does not work for matrix_row 
 */
inline Scalar* TheMatrix::Data() const 
{                
        // svnvish: BUGBUG
        // deprecated function?
 ...
 */
inline void TheMatrix::Get(const unsigned int& index, Scalar& value) const{
 ...
 * @param value [write] data value.
 */
inline void TheMatrix::Get(const unsigned int& row, const unsigned int& column, Scalar& value) const{
 ...
 */
inline void TheMatrix::Set(const unsigned int& index, const Scalar& value){
 ...
 * @param value [read] data value.
 */
inline void TheMatrix::Set(const unsigned int& row, const unsigned int& column, const Scalar& value){
 ...
 */
inline void TheMatrix::Norm1(Scalar& value) const{
 ...
 */
inline void TheMatrix::Norm2(Scalar& value) const{
 ...
 */
 inline void TheMatrix::NormInf(Scalar& value) const{
 ...
 */
inline void TheMatrix::Scale(const Scalar& sfactor)
{
 ...
 */
inline void TheMatrix::ScaleAdd(const Scalar& sfactor, 
 ...
 */
inline void TheMatrix::dv_scaleadd(const Scalar& scalar, 
                                   const TheMatrix& other){
 ...
 */
inline void TheMatrix::dmr_scaleadd(const Scalar& scalar, const TheMatrix& other)
{
        int otherType = other.Type();
        assert(id != other.ID());      // use Scale() instead!
 ...
 */
inline void TheMatrix::sv_scaleadd(const Scalar& scalar, 
                                   const TheMatrix& other){
  int otherType = other.Type();
  assert(id != other.ID());      // use Scale() instead!
 ...
 */
inline void TheMatrix::smr_scaleadd(const Scalar& scalar, 
                                   const TheMatrix& other){
  int otherType = other.Type();
  assert(id != other.ID());      // use Scale() instead!
 ...
 */
inline void TheMatrix::dm_scaleadd(const Scalar& scalar, 
                                   const TheMatrix& other){
  int otherType = other.Type();
  assert(id != other.ID());      // use Scale() instead!
 ...
 */
inline void TheMatrix::sm_scaleadd(const Scalar& scalar, 
                                   const TheMatrix& other){
  int otherType = other.Type();
  assert(id != other.ID());      // use Scale() instead!
...
inline void TheMatrix::dv_assign(const TheMatrix& other){
  ...
  case SML::DENSE_MATRIX: 
    ...
    memcpy(&(dv->data()[0]), &(other.dm->data()[0]), sizeof(Scalar)*length);
    break;
  }
  return;
}
...
inline void TheMatrix::dm_assign(const TheMatrix& other){
   ...
   switch(otherType){
      ...
      case SML::DENSE_VECTOR: 
         assert(length == other.length);
         memcpy(&(dm->data()[0]), &(other.dv->data()[0]), sizeof(Scalar)*length);
         break;
   }
   return;
}
