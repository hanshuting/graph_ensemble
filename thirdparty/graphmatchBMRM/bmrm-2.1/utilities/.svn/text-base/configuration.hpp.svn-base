...
class Configuration {
 private:
        ...
        typedef std::map<string,double> d_map;
        typedef std::map<string,double>::iterator d_itr;
        d_map doubles;
  
        typedef std::map<string,vector<double> > dvec_map;
        typedef std::map<string,vector<double> >::iterator dvec_itr;
        dvec_map doublevectors;
  
        typedef std::map<string,int> i_map;
        typedef std::map<string,int>::iterator i_itr;
        i_map ints;

        typedef std::map<string,vector<int> > ivec_map;
        typedef std::map<string,vector<int> >::iterator ivec_itr;
        ivec_map intvectors;
  
        typedef std::map<string,bool> b_map;
        typedef std::map<string,bool>::iterator b_itr;
        b_map bools;
  
        typedef std::map<string,vector<bool> > bvec_map;
        typedef std::map<string,vector<bool> >::iterator bvec_itr;
        bvec_map boolvectors;
  
        typedef std::map<string,string> s_map;
        typedef std::map<string,string>::iterator s_itr;
        s_map strings;
...
public:
         ...
         * @param value the value to be set.
         */
        void SetDoubleVector(std::string name, vector<double> &value);
         ...
         * @throws CBMRMException if the given parameter cannot be found
         */	
        vector<double>& GetDoubleVector(std::string name);
         ...
         * @param value the value to be set.
         */
        void SetIntVector(std::string name, vector<int> &value);
         ...
         * @throws CBMRMException if the given parameter cannot be found
         */	
        vector<int>& GetIntVector(std::string name);
         ...
         * @param value the value to be set.
         */
        void SetBoolVector(std::string name, vector<bool> &value);
         ...
         * @throws CBMRMException if the given parameter cannot be found
         */	                
        vector<bool>& GetBoolVector(std::string name);
         ...
         * @throws CBMRMException if the given parameter cannot be found
         */	
        string GetString(std::string name);
         ...
         * @param value the value to be set.
         */
        void SetStringVector(std::string name, vector<string> &value);
         ...
         * @throws CBMRMException if the given parameter cannot be found
         */	
        vector<string>& GetStringVector(std::string name);
