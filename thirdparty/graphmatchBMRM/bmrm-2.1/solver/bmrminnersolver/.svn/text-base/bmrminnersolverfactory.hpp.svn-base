...
//          else if(innerSolverType == "L2N2_SMO")
//	 {
//	    innerSolver = new CL2N2_SMO();
//	 }
 	 else if(innerSolverType == "L2N2_GMN")
 	 {
 	    innerSolver = new CL2N2_GMN(lambda);
 	 }
	 ...
	 {
	    throw CBMRMException("unknown innerSolverType <" + innerSolverType + ">", "CBMRMInnerSolverFactory::GetBMRMInnerSolver()");
	 }
