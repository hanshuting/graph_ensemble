function [params times fvals histMinFunc testResult] = train_labelers_KT_INSTRUMENTED(loss_spec,params0,testmode,...
...
function outputFcn(x,optimValues,state,varargin)
    if strcmp(state, 'iter')
        ...
        histMinFunc(end+1) = struct('iter', optimValues.iteration, ...
            ...
            'totTime', toc(instrumentTimeBegin));
