...
void mexFunction(int nOut, mxArray *pOut[], int nIn, const mxArray *pIn[]) {
  ...
  // Make copy of W, because we need to sqrt each entry.
  // true => I own the pointer (and the destructor will call mxDestroyArray)
  Mat<double> W(mxDuplicateArray(pIn[0]), true);
